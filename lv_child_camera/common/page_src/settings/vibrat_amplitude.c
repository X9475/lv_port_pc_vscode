...
lv_subject_t vibrat_amplitude_subject;
...
static lv_page_info_t vibrat_amplitude_page_info = {
    .page_id = PAGE_FUNCTIONAL_VIBRAT_AMPLITUDE,
    .page = NULL,
    .reserved = NULL,
...
{
    return &vibrat_amplitude_page_info;
}
...
static void lv_page_construct(void *this)
{
    ...
    vibrat_amplitude_page_info.page = screen;
    return;
}
...
static void lv_page_subject_init()
{
    lv_subject_init_int(&vibrat_amplitude_subject, PAGE_SWITCH_NONE);
    lv_subject_add_observer(&vibrat_amplitude_subject, lv_switch_observer_cb, NULL);
    return;
}

static void lv_page_subject_deinit()
{
    lv_subject_deinit(&vibrat_amplitude_subject);
}
...
static void page_back_event_cb(lv_event_t *e)
{
    lv_subject_set_int(&vibrat_amplitude_subject, PAGE_SWITCH_BACK);
}
...
static void lv_switch_observer_cb(lv_observer_t *observer, lv_subject_t *subject)
{
    ...
    switch_page->old_page = &vibrat_amplitude_page_info;
