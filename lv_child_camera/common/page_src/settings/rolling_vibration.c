...
lv_subject_t roller_vibrat_subject;
...
static lv_page_info_t roller_vibrat_page_info = {
    .page_id = PAGE_FUNCTIONAL_ROLLER_VIBRAT,
    .page = NULL,
    .reserved = NULL,
...
{
    return &roller_vibrat_page_info;
}
...
static void lv_page_construct(void *this)
{
    ...
    roller_vibrat_page_info.page = screen;
    return;
}
...
static void lv_page_subject_init()
{
    lv_subject_init_int(&roller_vibrat_subject, PAGE_SWITCH_NONE);
    lv_subject_add_observer(&roller_vibrat_subject, lv_switch_observer_cb, NULL);
    return;
}

static void lv_page_subject_deinit()
{
    lv_subject_deinit(&roller_vibrat_subject);
}
...
static void lv_page_load(lv_obj_t *cont)
{
    ...
    lv_label_set_text(header, "滚轮振动开关");
...
static void page_back_event_cb(lv_event_t *e)
{
    lv_subject_set_int(&roller_vibrat_subject, PAGE_SWITCH_BACK);
}
...
static void lv_switch_observer_cb(lv_observer_t *observer, lv_subject_t *subject)
{
    ...
    switch_page->old_page = &roller_vibrat_page_info;
