...
lv_subject_t time_display_subject;
...
static lv_page_info_t time_display_page_info = {
    .page_id = PAGE_FUNCTIONAL_DISPLAY_TIME,
    .page = NULL,
    .reserved = NULL,
...
static void lv_page_construct(void *this)
{
    ...
    time_display_page_info.page = screen;
    return;
}
...
static void lv_page_subject_init()
{
    lv_subject_init_int(&time_display_subject, PAGE_SWITCH_NONE);
    lv_subject_add_observer(&time_display_subject, lv_switch_observer_cb, NULL);
    return;
}

static void lv_page_subject_deinit()
{
    lv_subject_deinit(&time_display_subject);
}
...
static void page_back_event_cb(lv_event_t *e)
{
    lv_subject_set_int(&time_display_subject, PAGE_SWITCH_BACK);
}
...
static void lv_switch_observer_cb(lv_observer_t *observer, lv_subject_t *subject)
{
    ...
    switch_page->old_page = &time_display_page_info;
