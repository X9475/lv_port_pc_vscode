...
lv_subject_t remote_preview_subject;
...
static lv_page_info_t remote_preview_page_info = {
    .page_id = PAGE_FUNCTIONAL_REMOTE_PREVIEW,
    .page = NULL,
    .reserved = NULL,
...
{
    return &remote_preview_page_info;
}
...
static void lv_page_construct(void *this)
{
    ...
    remote_preview_page_info.page = screen;
    return;
}
...
static void lv_page_subject_init()
{
    lv_subject_init_int(&remote_preview_subject, PAGE_SWITCH_NONE);
    lv_subject_add_observer(&remote_preview_subject, lv_switch_observer_cb, NULL);
    return;
}

static void lv_page_subject_deinit()
{
    lv_subject_deinit(&remote_preview_subject);
}
...
static void lv_page_load(lv_obj_t *cont)
{
    ...
    lv_label_set_text(header, "远程预览开关");
...
static void page_back_event_cb(lv_event_t *e)
{
    lv_subject_set_int(&remote_preview_subject, PAGE_SWITCH_BACK);
}
...
static void lv_switch_observer_cb(lv_observer_t *observer, lv_subject_t *subject)
{
    ...
    switch_page->old_page = &remote_preview_page_info;
