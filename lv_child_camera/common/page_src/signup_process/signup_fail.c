...
lv_subject_t signup_failed_subject;
...
static lv_page_info_t signup_failed_page_info = {
    .page_id = PAGE_FUNCTIONAL_SIGNUP_FAILED,
    .page = NULL,
    .reserved = NULL,
...
static void lv_page_construct(void *this)
{
    ...
    signup_failed_page_info.page = screen;
    return;
}
...
static void lv_page_subject_init()
{
    lv_subject_init_int(&signup_failed_subject, PAGE_SWITCH_NONE);
    lv_subject_add_observer(&signup_failed_subject, lv_switch_observer_cb, NULL);
    return;
}

static void lv_page_subject_deinit()
{
    lv_subject_deinit(&signup_failed_subject);
}
...
static void retry_btn_click_event_cb(lv_event_t *e)
{
    lv_subject_set_int(&signup_failed_subject, PAGE_SWITCH_RETRY);
}
...
static void lv_switch_observer_cb(lv_observer_t *observer, lv_subject_t *subject)
{
    ...
    switch_page->old_page = &signup_failed_page_info;
